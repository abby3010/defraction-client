...
const { _mint, _transferToken, _unitsOwnedOfAToken, _divisibilityOfAToken, _totalSupplyView, _divisibilityOfTokens, _getPrice, _transferNftShare } = require('../controller/DivisibleNFTController');
...
router.post('/nft/transferShare', _transferNftShare);
